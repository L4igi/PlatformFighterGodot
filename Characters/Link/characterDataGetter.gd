...
func get_character_icon():
	return preload("res://Characters/Link/guielements/characterIcon.png")

func get_character_logo():
	return preload("res://Characters/Link/guielements/characterLogo.png")

func get_instance_path():
	var characterNode = load("res://Characters/Link/Link.tscn")
