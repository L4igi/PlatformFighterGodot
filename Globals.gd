...
var attackAnimationList = ["attack_getup", "bair", "dair", "dash_attack", "dsmash", "dtilt", "fair", "fsmash", "ftilt", "jab1", "jab2", "nair", "upair", "upsmash", "uptilt", "throw_item_up", "throw_item_down", "throw_item_forward", "upsmash1", "upsmash2", "upsmash3", "dsmash1", "dsmash2", "dsmash3", "fsmash1", "fsmash2", "fsmash3"]

var specialAnimationList = ["neutralspecial", "neutralspecialair", "downspecial", "downspecial", "sidespecial", "sidespecialair", "upspecial", "upspecialair", "counter", "cancel_charge"]
